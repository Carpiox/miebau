...
(function () {
  ...
  const isPonderaciones = page === 'ponderaciones.html' || path.indexOf('/ponderaciones/') === 0;
  const active = (file) => file === 'ponderaciones.html' ? (isPonderaciones ? 'active' : '') : (page === file ? 'active' : '');
      ...
      <footer class="site-footer">
        <div class="site-footer-inner">
          <div class="footer-top">
            ...
            <div class="footer-column"><div class="footer-heading">Herramientas</div><a href="/calculadora.html">Calculadora</a><a href="/ponderaciones">Ponderaciones</a><a href="/examenes.html">Exámenes</a><a href="/notas-de-corte.html">Notas de corte</a><a href="/calendario-ebau.html">Calendario EBAU</a></div>
            ...
            <div class="footer-column"><div class="footer-heading">Sobre nosotros</div><a href="/sobre-nosotros">Sobre nosotros</a><a href="/guias.html">Guías</a><a href="/contacto.html">Contacto</a></div>
